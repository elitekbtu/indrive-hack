...
def train(cfg: TrainConfig) -> str:
    ...
    best_val_acc = -1.0
    best_ckpt_path = os.path.join(cfg.output_dir, "damage_parts.pt")
...
def parse_args() -> TrainConfig:
    parser = argparse.ArgumentParser(description="Train multiclass car damage parts classifier")
    parser.add_argument(
        "--data_root",
        type=str,
        default=os.path.join("datasets", "car-damage.v1i.multiclass"),
